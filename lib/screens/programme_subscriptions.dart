...
class ProgramSubScriptions extends StatefulWidget {
  ProgramSubScriptions({Key key}) : super(key: key);

  @override
  _ProgramSubScriptionsState createState() => _ProgramSubScriptionsState();
}

class _ProgramSubScriptionsState extends State<ProgramSubScriptions> {
  int viewIndex = 0;
  final List<dynamic> programmes = [
    ...
    {
      'title': 'Understanding the Spiritual',
      'pastor': 'Ibiyeomi Davids',
      'status': 60,
      'church': 'Salvation ministries',
      'upload': '13th oct 20',
  ...
  Widget noProgrammes() {
    return Padding(
      ...
      child: Container(
          child: Column(
        children: [
          Text('You have not subscribed to any programs',
          ...
          SvgPicture.asset(
            'asset/images/noprogrammesubscrition.svg',
            fit: BoxFit.contain,
            height: 200,
          ),
          SizedBox(
  ...
  Widget programItem(dynamic data, BuildContext context) {
      ...
      child: viewIndex == 0
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return programItem(programmes[index], context);
              },
            ),
    );
  }
