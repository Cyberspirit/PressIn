...
class DailyMessage extends StatefulWidget {
  DailyMessage({Key key}) : super(key: key);
        ...
        child: Column(
          children: [
            Text(
              'Genesis 1:1-31',
              style: TextStyle(
                  color: Color.fromARGB(255, 121, 117, 148), fontSize: 16),
            ),
            SizedBox(
              height: 5,
            ),
            HtmlWidget(
                """<div>In the beginning God created the heaven and the earth.<br/>
...
1:11	  	And God said, Let the earth bring forth grass, the herb yielding seed, and the fruit tree yielding fruit after his kind, whose seed is in itself, upon the earth: and it was so.<br/>
1:12	  	And the earth brought forth grass, and herb yielding seed after his kind, and the tree yielding fruit, whose seed was in itself, after his kind: and God saw that it was good.<br/>
1:13	  	And the evening and the morning were the third day.
1:14	  	And God said, Let there be lights in the firmament of the heaven to divide the day from the night; and let them be for signs, and for seasons, and for days, and years:
1:15	  	And let them be for lights in the firmament of the heaven to give light upon the earth: and it was so.<br/>
1:16	  	And God made two great lights; the greater light to rule the day, and the lesser light to rule the night: he made the stars also.<br/>
...
1:31	  	And God saw every thing that he had made, and, behold, it was very good. And the evening and the morning were the sixth</div>"""),
            SizedBox(
              height: 20,
            ),
            RaisedButton(
