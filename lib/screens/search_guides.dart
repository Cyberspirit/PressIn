...
class SearchGuides extends StatefulWidget {
  SearchGuides({Key key}) : super(key: key);

  @override
  _SearchGuidesState createState() => _SearchGuidesState();
}

class _SearchGuidesState extends State<SearchGuides> {
            ...
            child: Container(
              ...
              child: FittedBox(
                child: Column(
                  children: [
                    ClipRRect(
                      child: Image.asset('asset/images/Image2x.png'),
                    ),
                    Padding(
      ...
      child: new Container(
          ...
          decoration: new BoxDecoration(
            image: new DecorationImage(
              image: new AssetImage('asset/images/guddesearcg.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: new Stack(
      ...
      children: [
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Discover great prayer guides',
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontFamily: "avenir",
                        fontSize: 20,
        ...
        Center(
          child: Opacity(
            ...
            child: Text('Discover prayer guides',
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: "avenir",
                    fontSize: 25,
...
class BackgroundWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Image.asset('asset/images/guddesearcg.jpg', fit: BoxFit.cover);
  }
}
